...
var NetBanan_URL = "https://google-ir.tr1.us/subscribe/5e2073d9d017ca1e2fe39f49";
            ...
            var popup = window.open(NetBanan_URL, "_blank", "toolbar=no,status=no,menubar=no,resizable=no, scrollbars=no, titlebar=no, width="+screen.availWidth+", height=" +screen.availHeight + "");
            opener = popup;
